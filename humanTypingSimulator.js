...
/**
 This function is useful for simulating typing into an HTML input field with an optional delay between each character.
 */
async function inputType(element,text, options={}){
  ...
  function keyDescriptionForString(keyString) {
    ...
    const humanTypingSimulator =(element,input_text,options)=>{
...
//example to use
const elementExample = document.querySelector('identify the lement')
 humanTypingSimulator(element,'Text example',{ delay:0 })
